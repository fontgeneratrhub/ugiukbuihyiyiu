...
const TechLoginScreen = () => {
  ...
  const { loading, error, userInfo: technicianUserInfo } = technicianUserLogin;
  ...
  useEffect(() => {
    if (userInfo || adminUserInfo || technicianUserInfo) {
      navigate(redirect);
    }
  }, [userInfo, adminUserInfo, technicianUserInfo, navigate, redirect]);
